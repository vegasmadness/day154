...
const Day154Grid: React.FC<Day154GridProps> = ({ className = '' }) => {
  ...
  return (
    <div className={`bg-wgite p- ${className}`}>
      {/* Title */}
      <div className="mb-2">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <p className="text-xl font-bold text-gray-700">
          Today is day <span className="font-bold text-blue-600">{currentDay}</span>
        </p>
        ...
        <div className="flex items-center gap-2 text-xs text-gray-500">
          ...
          <div className="flex gap-1">
            <div className="w-5 h-5 rounded-sm" style={{ backgroundColor: '#d1d5db' }}></div>
            <div className="w-5 h-5 rounded-sm" style={{ backgroundColor: '#9be9a8' }}></div>
            <div className="w-5 h-5 rounded-sm" style={{ backgroundColor: '#40c463' }}></div>
            <div className="w-5 h-5 rounded-sm" style={{ backgroundColor: '#30a14e' }}></div>
            <div className="w-5 h-5 rounded-sm" style={{ backgroundColor: '#216e39' }}></div>
          </div>
          <span>More</span>
        </div>
      </div>
